...
# MATLAB palette
set palette defined (0 0 0 .5, 0.125 0 0 1, 0.375 0 1 1, 0.5 0 0.8 0, 0.625 1 1 0, 0.875 1 0 0, 1 0.5 0 0)
...
set cblabel "P_{RX}(x,y) [dBm]" offset 1.25


PREDICTION_HEIGHT=1.2

# Zone A1 - Received Power, w/ EMS 1
# =======================================
set out 'Fig.Received.Power.Mesiano.EMS.N.Hallway-B2.eps'
...
file_in1="../".path_to_stuff."/Analysis/EMS.Received.Power.x.Plot.dat"
...
plot file_in1 u 1:2:(10*log10($6)+30) w imag notitle,\
     ...
     file_in6 u 1:2 w p pt 7 ps 1.25 lc rgb 'white' notitle,\
